...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  DataStreamSource<String> text = env.socketTextStream("127.0.0.1", port, "\n");
        ...
        DataStreamSource<String> dataStreamSource = env.fromCollection(word);

        DataStream<WordWithCount> windowCount = dataStreamSource.flatMap(new FlatMapFunction<String, WordWithCount>() {
